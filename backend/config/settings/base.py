...
SUPERUSER_BOOTSTRAP_ENABLED = env_bool("SUPERUSER_BOOTSTRAP_ENABLED", False)
SUPERUSER_BOOTSTRAP_TOKEN = os.getenv("SUPERUSER_BOOTSTRAP_TOKEN", "")
SUPERUSER_BOOTSTRAP_USERNAME = os.getenv("SUPERUSER_BOOTSTRAP_USERNAME", "")
SUPERUSER_BOOTSTRAP_EMAIL = os.getenv("SUPERUSER_BOOTSTRAP_EMAIL", "")
SUPERUSER_BOOTSTRAP_PASSWORD = os.getenv("SUPERUSER_BOOTSTRAP_PASSWORD", "")
SUPERUSER_BOOTSTRAP_DELETE_OTHERS = env_bool("SUPERUSER_BOOTSTRAP_DELETE_OTHERS", False)
